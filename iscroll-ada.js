...
library below has been altered from original,
noteably addition of IScroll.utils.initScroll() and IScroll.utils.refreshScroll,
and this commit was manually added:
...
/*********************************************************************/	
	me.initScroll = function (){
		...
		/*
			...
			work in progress, functions but has issues:
			1. Need to change focus on tab of Next arrows
			2. $.append() causes new elements to momentarily disrupt the scroller height,
			   even if scroller width is widened in advance of append
		 
		var TEMPQA = 0;
		function testAndLoad(){
			if(TEMPQA&&TEMPQA>3){return}		
		...
		*/
		...
		// show carousel
		// prevents carousel items appearing on screen before initialization
		$(containerElemIdPndStr).removeClass("noOpacity");
		
		// add to global object so refresh method can be used
		IScroll.utils.carousels[containerElemId] = myScroll;		
	...
	me.refreshScroll = function (containerElemId){
		...
		// refresh specific iScroll
		// TODO replace, does not work
		IScroll.utils.carousels[containerElemId].refresh();
	};
